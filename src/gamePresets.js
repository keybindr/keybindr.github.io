...
export const GAME_PRESETS = [
  {
    ...
    formats: [{ name: 'Default', bindings: WOW_BINDINGS, keyColors: computeKeyColors(WOW_BINDINGS, WOW_ACTION_COLORS) }],
    importLabel: 'Import WoW .wtf',
    importAccept: '.wtf',
    importFn: parseWTF,
    exportLabel: 'Export WoW .wtf',
    exportFn: exportWTF,
  },
  {
    id: 'ffxiv',
    ...
    formats: [
      { name: 'Default', bindings: [...FFXIV_CONTROLS_BINDINGS, ...FFXIV_HOTBAR_BINDINGS], keyColors: computeKeyColors([...FFXIV_CONTROLS_BINDINGS, ...FFXIV_HOTBAR_BINDINGS], FFXIV_ACTION_COLORS) },
    ],
  },
  {
    id: 'eso',
    ...
    formats: [{ name: 'Default', bindings: ESO_BINDINGS, keyColors: computeKeyColors(ESO_BINDINGS, ESO_ACTION_COLORS) }],
  },
  {
    id: 'arma3',
    label: 'Arma 3',
    ...
    formats: [
      { name: 'On Foot',  bindings: ARMA_FOOT_BINDINGS,     keyColors: computeKeyColors(ARMA_FOOT_BINDINGS,     ARMA_ACTION_COLORS) },
      { name: 'Vehicle',  bindings: ARMA_VEHICLE_BINDINGS,   keyColors: computeKeyColors(ARMA_VEHICLE_BINDINGS,   ARMA_ACTION_COLORS) },
      { name: 'Aircraft', bindings: ARMA_AIRCRAFT_BINDINGS,  keyColors: computeKeyColors(ARMA_AIRCRAFT_BINDINGS,  ARMA_ACTION_COLORS) },
    ],
  },
  {
    id: 'gw2',
    ...
    formats: [{ name: 'Default', bindings: GW2_BINDINGS, keyColors: computeKeyColors(GW2_BINDINGS, GW2_ACTION_COLORS) }],
  },
];
